...
public static class EquipmentDataExtensions
{
	...
	public static bool IsLateModelTorpedo(this IEquipmentDataMaster equip) => equip.EquipmentId is
		...
		EquipmentId.SubmarineTorpedo_SkilledSonarPersonnel_LateModelBowTorpedoMount_4tubes or
		EquipmentId.SubmarineTorpedo_21inch4tubeBowTorpedoLauncher_LateModel;
	...
	public static bool IsAircraft(this IEquipmentData? equipment) => equipment?.MasterEquipment.IsAircraft() is true;
