...
public record DayAttack
{
	...
	/// 昼戦攻撃種別を表す文字列を取得します。
	/// </summary>
	public static string AttackDisplay(DayAttackKind id, List<IEquipmentDataMaster>? displayEquipment = null)
		=> id switch
		{
			...
			DayAttackKind.CutinAirAttack => displayEquipment.GetDayAirAttackCutinKind() switch
			{
